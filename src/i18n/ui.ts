...
const zh: Strings = {
  ...
  docs: {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          '邮箱注册并验证:用官方 Mochi 云,验证邮箱后每天 50 次 AI 对话免费(未验证邮箱为 0 次)',
      ...
      },
      {
        ...
        icon: '🧰',
        title: '五、开启工具能力',
        intro: 'Mochi 能接管手机做事,但这些工具默认全关,需要你亲手打勾授权。',
        steps: [
          '进入「设置 → 客户端工具」,按分组打开你需要的:',
          '提醒与日程:闹钟、计时器、日历',
          '联系人与通讯:通讯录(查找/新建/修改联系人,或打开拨号、短信草稿)',
          '打开与分享:链接、地图(搜索地点 / 定位)、分享文字(到微信、QQ、便签等)',
          '每开一项,Mochi 的大脑才能调用对应能力;不需要的保持关闭更安全',
        ],
        note: '通知和触觉反馈是常驻能力、无需单独开关。拨号和发短信仍需你在系统界面手动确认,Mochi 不会自动拨出或发送。',
      },
      {
        id: 'clock',
        icon: '🕐',
    ...
    faq: [
      ...
      { q: '免费额度用完了怎么办?', a: '验证邮箱后官方云每天 50 次免费对话,用完会暂停;切换到 BYOK 填自己的 API Key 即可继续无限使用。' },
...
const en: Strings = {
  ...
  docs: {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          'Email signup + verify: use the official Mochi cloud — 50 free AI chats per day once your email is verified (0 if unverified)',
      ...
      },
      {
        ...
        intro: 'Mochi can take over your phone, but these tools are off by default and need your explicit opt-in.',
        steps: [
          'Open Settings → Client tools and enable what you need by group:',
          'Reminders & schedule: alarms, timers, calendar',
          'Contacts & communication: contacts (find/create/edit, or open dialer & SMS draft)',
          'Open & share: links, maps (search a place / locate), share text (to WeChat, QQ, notes, etc.)',
          'Only after you enable a tool can Mochi’s brain use it — keep what you don’t need off',
        ],
        note: 'Notifications and haptics are always-on and need no toggle. Dialing and sending SMS still require your manual confirmation in the system UI — Mochi never auto-dials or auto-sends.',
      },
      {
        id: 'clock',
        icon: '🕐',
    ...
    faq: [
      ...
      { q: 'What if I run out of free quota?', a: 'After verifying your email, the official cloud gives 50 free chats per day; when used up it pauses. Switch to BYOK with your own API key to keep going unlimited.' },
...
const ja: Strings = {
  ...
  docs: {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          'メール登録 + 認証:公式 Mochi クラウドを使用。メール認証後は毎日 50 回の AI 対話が無料(未認証は 0 回)',
      ...
      },
      {
        ...
        icon: '🧰',
        title: '5 · ツールを有効化',
        intro: 'Mochi はスマホを操作できますが、これらのツールは初期状態でオフ。自分で許可が必要です。',
        steps: [
          '設定 → クライアントツールを開き、グループごとに必要なものをオン:',
          'リマインダーと予定:アラーム、タイマー、カレンダー',
          '連絡先と通信:連絡先(検索 / 新規 / 編集、または発信・SMS 下書きを開く)',
          '開く & 共有:リンク、地図(場所検索 / 位置特定)、テキスト共有(WeChat、QQ、メモなどへ)',
          '有効化して初めて Mochi の頭脳が使えます。不要なものはオフのままが安全',
        ],
        note: '通知と触覚フィードバックは常時オンで、切り替え不要です。発信や SMS 送信はシステム画面での手動確認が必要 — Mochi が自動で発信・送信することはありません。',
      },
      {
        id: 'clock',
        icon: '🕐',
    ...
    faq: [
      ...
      { q: '無料枠を使い切ったら?', a: 'メール認証後、公式クラウドは毎日 50 回の無料対話を提供し、使い切ると一時停止します。BYOK に切り替えて自分の API Key を使えば無制限で継続できます。' },
